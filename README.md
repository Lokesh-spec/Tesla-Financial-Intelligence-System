...
![RAG Pipeline Architecture](images/RAG_Pipeline.png)
...
![Summary of Tesla 2023 performance](images/Summary_of_Tesla_2023_performance.png)

*Summary of Tesla 2023 performance.*

![How did net income change from 2020 to 2023](images/How_did_net_income_change_from_2020_to_2023.png)

*Example answer for net income change over time.*

![Compare Tesla revenue between 2017 and 2024](images/Compare_Tesla_revenue_between_2017_and_2024.png)

*Revenue comparison across years as generated by the system.*

![Sample terminal output from the Streamlit app](images/terminal_output.png)

*Streamlit output example showing how the question-answering interface displays results.*
...
**Important:** Never commit your `.env` file to version control. It is already in `.gitignore`.
...
![Terminal Query Engine Output](images/terminal_output.png)
